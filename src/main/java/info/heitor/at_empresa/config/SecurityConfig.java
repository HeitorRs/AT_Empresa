package info.heitor.at_empresa.config;

import info.heitor.at_empresa.service.CustomUserDetailService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/funcionarios/**").permitAll() //estou permitindo que acessem a minha API sem autenticação
                        .requestMatchers("/departamentos/**").permitAll()
                        .requestMatchers("/usuarios/**").permitAll()
                        .requestMatchers("/usuarioSecurity/**").permitAll()
